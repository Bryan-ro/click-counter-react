                ...
                {navVisibility && (
                    <nav className="sm:w-72 w-screen animate-fade-in sm:relative absolute h-full bg-white">
                        ...
                        <div className="h-full mt-4">
                            ...
                            <div className={`${optionStyle} ${props.page === "dashboard" ? "text-primary" : ""}`} onClick={() => props.page === "dashboard" ? null : navigate("/dashboard")}>
                            ...
                            {login && (
                                <div className={`${optionStyle} ${props.page === "profile" ? "text-primary" : ""}`} onClick={() => props.page === "profile" ? null : navigate("/profile")}>
